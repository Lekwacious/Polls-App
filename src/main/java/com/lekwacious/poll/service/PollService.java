package com.lekwacious.poll.service;

import com.lekwacious.poll.data.models.*;
...
import com.lekwacious.poll.exception.BadRequestException;
...
import com.lekwacious.poll.utils.ModelMapper;
...
public PollResponse getPollById(Long pollId, UserPrincipal currentUser){
    ...
    List<ChoiceVoteCount> votes = voteRepository.countByPollIdGroupByChoiceId(Collections.singletonList(pollId));
    Map<Long, Long> choiceVotesMap = votes.stream()
            .collect(Collectors.toMap(ChoiceVoteCount::getChoiceId, ChoiceVoteCount::getVoteCount));

    // Retrieve poll creator details
    User creator = userRepository.findById(Math.toIntExact(poll.getCreatedBy()))
 ...
 return ModelMapper.mapPollToPollResponse(poll,choiceVotesMap, creator,userVote != null? userVote.getChoice().getId(): null);
    ...
    public PollResponse castVoteAndGetUpdatedPoll(Long pollId, VoteRequest voteRequest, UserPrincipal currentUser) {
        ...
        User user = userRepository.getOne(Math.toIntExact(currentUser.getId()));
